        ...
        function getRows($params = array())
        {
          /*  $this->db->select('*'); 
            $this->db->from($this->table); */
                ...
                $this->db->select('c.*, admin.title as createdby, bookstatus.title as booked_status,calltype.title as calltypename, document.title as documentname, document_category.title as documentcategoryname ,admin2.title as assignedto');
                $this->db->from($this->table. ' as c'); 
